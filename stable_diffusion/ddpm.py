...
class DDPMSampler:
    ...
    def _get_variance(self , timestep : int) -> torch.Tensor :
        ...
        variance = (1 - alpha_prod_t_prev ) / (1- alpha_prod_t_prev) * current_beta_t
    ...
    def step(self , timestep: int , latents: torch.Tensor , model_output: torch.Tensor):
        ...
        # compute the predicted original smap,e using forumula 15 of ddpm paper
        pred_original_sample = (latents - beta_prod_t ** 0.5 * model_output) / alpha_prod_t ** 0.5

        # compute the coefficient for pred_original_sample and current_sample x_t
        pred_original_sample_coeff = (alpha_prod_t_prev ** 0.5 *  current_beta_t) / beta_prod_t
        current_sample_coeff= current_alpha_t ** 0.5 * beta_prod_t / beta_prod_t
    ...
    def add_noise(self, original_samples:torch.FloatTensor , timesteps : torch.IntTensor) -> torch.FloatTensor:
        ...
        sqrt_one_minus_alpha_prod = (1- alpha_cumpod[timesteps])** 0.5
